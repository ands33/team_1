...
public class UserVO {
	...
	public String getU_emailAddr() {
		return u_emailAddr;
	}

	public void setU_emailAddr(String u_emailAddr) {
		this.u_emailAddr = u_emailAddr;
	}
	...
	public String toString() {
		return "UserVO [u_seq=" + u_seq + ", u_name=" + u_name + ", u_gender=" + u_gender + ", u_id=" + u_id + ", u_pw="
				+ u_pw + ", u_pwc=" + u_pwc + ", u_addr=" + u_addr + ", u_email=" + u_email +", u_emalAddr="+u_emailAddr +", u_phone=" + u_phone
				+ ", u_hobby=" + u_hobby + ", u_introduce=" + u_introduce + ",u_regdate"+"]";
	}
