...
public class BoardDAO {
	...
	// 제목에 검색어가 포함된것
	private final String BOARD_tLIST = "select * from board where title like '%'||?||'%' order by seq desc";
	// 내용에 검색어가 포함된것
	private final String BOARD_cLIST = "select * from board where content like '%'||?||'%' order by seq desc";
